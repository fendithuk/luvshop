                    ...
                    <ul>
                        <li style="background-image: url('<?php include('../elemen/url.php'); ?>image/menu.jpg');" id="lili">
                            <ul style="margin: 0;padding: 0;list-style: none">
                                ...
                                <li class="background_menu"><a href="<?php include('../elemen/url.php'); ?>memberarea/memberarea.php" style="color: #f08cca;position: absolute; margin-left: -75px; width: 149px;">Home</a></li>
