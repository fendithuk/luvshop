...
<ul style="margin: 0;padding: 0;list-style: none">
    ...
    <li class="background_menu" id="home" ><a href="<?php include('url.php'); ?>home/home.php" style="color: #f08cca;" >Home</a></li>
    ...
    <li style="height: 30px" id="shipment"><a href="" style="color: #f08cca;" >Shipment</a></li>
